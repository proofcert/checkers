...
let _ = 
  ...
  with
    | Invalid_argument("index out of bounds") -> 
      print_endline ("\nUsage: tstpparser proof_file proof_certificate");
      print_endline ("where: ");
      print_endline ("- 'proof_file' is the name of the file containing a proof \
  evidence from a theorem prover.");
      print_endline ("- 'proof_certificate' will be the name of the .mod and .sig \ 
  files generated with the corresponding proof certificate for checkers.\n");
      exit 0
;;
