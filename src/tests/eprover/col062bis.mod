...
(rsteps [pm (id (idx 8)) (id (idx 15)) 7, pm (id (idx 7)) (id (idx 16)) 6, pm (id (idx 6)) (id (idx 15)) 5, pm (id (idx 5)) (id (idx 15)) 4, pm (id (idx 4)) (id (idx 16)) 3, pm (id (idx 3)) (id (idx 15)) 2, pm (id (idx 2)) (id (idx 15)) 1, pm (id (idx 1)) (id (idx 16)) 0] estate )
 (map [
pr 0 f-,
