...
(rsteps [pm (id (idx 31)) (id (idx 32)) 9, pm (id (idx 31)) (id (idx 9)) 7, pm (id (idx 31)) (id (idx 7)) 5, pm (id (idx 4)) (id (idx 5)) 3, pm (id (idx 14)) (id (idx 32)) 13, pm (id (idx 13)) (id (idx 31)) 12, pm (id (idx 3)) (id (idx 12)) 2, pm (id (idx 31)) (id (idx 32)) 21, pm (id (idx 31)) (id (idx 21)) 19, pm (id (idx 31)) (id (idx 19)) 17, pm (id (idx 2)) (id (idx 17)) 1, pm (id (idx 31)) (id (idx 32)) 30, pm (id (idx 31)) (id (idx 30)) 28, pm (id (idx 31)) (id (idx 231)) 26, pm (id (idx 31)) (id (idx 231)) 24, pm (id (idx 1)) (id (idx 24)) 0] estate )
 (map [
