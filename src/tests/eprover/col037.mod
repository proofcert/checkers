...
resProblem "col037" [(pr 14 (all (X1\ (all (X2\ (all (X3\ (n ((apply (apply (apply b X1) X2) X3) == (apply X1 (apply X2 X3)))))))))) ),
...
(resteps [pm (id (idx 10)) (id (idx 11)) 9, pm (id (idx 10)) (id (idx 9)) 7, pm (id (idx 10)) (id (idx 7)) 5, pm (id (idx 4)) (id (idx 5)) 3, pm (id (idx 14)) (id (idx 15)) 13, pm (id (idx 13)) (id (idx 16)) 12, pm (id (idx 3)) (id (idx 12)) 2, pm (id (idx 22)) (id (idx 23)) 21, pm (id (idx 22)) (id (idx 21)) 19, pm (id (idx 22)) (id (idx 19)) 17, pm (id (idx 2)) (id (idx 17)) 1, pm (id (idx 31)) (id (idx 32)) 30, pm (id (idx 31)) (id (idx 30)) 28, pm (id (idx 31)) (id (idx 28)) 26, pm (id (idx 31)) (id (idx 26)) 24, pm (id (idx 1)) (id (idx 24)) 0])
 (map [
