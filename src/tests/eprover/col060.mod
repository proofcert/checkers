...
resProblem "col060" [(pr 11 (all (X1\ (all (X2\ (n ((apply (apply t X1) X2) == (apply X2 X1))))))) ),
...
(resteps [pm (id (idx 6)) (id (idx 7)) 5, pm (id (idx 5)) (id (idx 8)) 4, pm (id (idx 4)) (id (idx 9)) 3, pm (id (idx 3)) (id (idx 10)) 2, pm (id (idx 2)) (id (idx 11)) 1, pm (id (idx 1)) (id (idx 12)) 0])
 (map [
