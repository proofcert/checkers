...
resProblem "col052" [(pr 8 (all (X1\ (n ((response c (common_bird X1)) == (response X1 (common_bird X1)))))) ),
...
(resteps [pm (id (idx 4)) (id (idx 5)) 3, pm (id (idx 2)) (id (idx 3)) 1, pm (id (idx 7)) (id (idx 8)) 6, pm (id (idx 1)) (id (idx 6)) 0])
 (map [
