...
resProblem "col063" [(pr 16 (all (X1\ (all (X2\ (n ((apply (apply t X1) X2) == (apply X2 X1))))))) ),
...
(resteps [pm (id (idx 8)) (id (idx 9)) 7, pm (id (idx 7)) (id (idx 10)) 6, pm (id (idx 6)) (id (idx 11)) 5, pm (id (idx 5)) (id (idx 12)) 4, pm (id (idx 4)) (id (idx 13)) 3, pm (id (idx 3)) (id (idx 14)) 2, pm (id (idx 2)) (id (idx 15)) 1, pm (id (idx 1)) (id (idx 16)) 0])
 (map [
...
pr 15 (all (X1\ (all (X2\ (n ((apply (apply t X1) X2) == (apply X2 X1))))))),
