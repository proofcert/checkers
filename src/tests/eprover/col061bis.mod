...
(rsteps [pm (id (idx 6)) (id (idx 11)) 5, pm (id (idx 5)) (id (idx 12)) 4, pm (id (idx 4)) (id (idx 11)) 3, pm (id (idx 3)) (id (idx 11)) 2, pm (id (idx 2)) (id (idx 11)) 1, pm (id (idx 1)) (id (idx 12)) 0] estate )
 (map [
