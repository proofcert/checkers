...
(rsteps [variable_rename (id (idx 5)) 4, split_conjunct (id (idx 4)) 3, variable_rename (id (idx 8)) 7, split_conjunct (id (idx 7)) 6, pm (id (idx 3)) (id (idx 6)) 2, assume_negation (id (idx 12)) 11, fof_simplification (id (idx 11)) 10, split_conjunct (id (idx 11)) 9, rw (id (idx 2)) (id (idx 11)) 1, cn (id (idx 1)) 0] estate)
 (map [
