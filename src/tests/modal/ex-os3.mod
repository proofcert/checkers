...
(ordinary-sequent-cert (ordinary-sequent-state [root] none [pr root root] 0 [] [])
  ...
  lmf-tree (ordinary-sequent-node (rind _) [(lind (rind root)), (lind root)]) [

%  lmf-tree (ordinary-sequent-node [root] (rind (rind root)) (lmf-multifoc-node 4 (lmf-singlefoc-node (lind (rind root)) (rind (rind root))))) [

%  lmf-tree (lmf-star-node [rind _] (rind _) _) [

  lmf-tree (ordinary-sequent-node (diaind _ (rind (rind root))) [none]) [
  ...
  lmf-tree (ordinary-sequent-node _ _) []],
