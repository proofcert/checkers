...
(dectree eind _)
  ...
  (axiom-map [axiom-entry trans-ind [default-ind, rind (rind eind), bind (lind (rind eind)) (rind (rind eind))], axiom-entry trans-ind [rind (rind eind), bind (lind (rind eind)) (rind (rind eind)), rind (bind (lind eind) (bind (lind (rind eind)) (rind (rind eind))))]])
 (snum (snum znum))
