...
% type simpfitcert boolean -> list index -> list closure -> list boxinfo -> list (pair index atm) -> list used -> cert.

%decide_ke (simpfitcert F I C B E U) D (simpfitcert 1 [D] C B E U) :- member (closure D X) C. % literal case
decide_ke (simpfitcert F I C B E U) D (simpfitcert 1 [D] C B E [U|used D]) :- not (member (used D) U). % general case
...
store_kc (simpfitcert F I C B E U) (n (rel X Y)) none (simpfitcert 0 I C B E [U|used D])*** :- !. % in the case of relational atoms, we use none as the index
store_kc (simpfitcert F I C B E U) (p (rel X Y)) none (simpfitcert 0 I C B E [U|used D]) :- !. % in the case of relational atoms, we use none as the index
...
initial_ke (simpfitcert F [I|T] C B E U) Compl :- member (closure I Compl) C.
...
some_ke (simpfitcert F [I] C B E U) X (simpfitcert 0 [bind I O] C B2 E U2) :- member (pr O X) E, memb_and_rest (boxinfo I O) B B2, memb_and_rest I U U2. %
