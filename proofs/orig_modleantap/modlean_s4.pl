...
% The box rule (with T and 4 extensions)
...
prove(box Fml,Label,Univ,Lits,UnExp,Sleep,Free,Limit) :- !,
	copy_term((Label,Univ,Free),(LabelT,UnivT,Free)),
        ...
        append(Sleep,[([Y|Univ4]:[Y|Label4]:(box Fml))-[none]],NewSleep),
        prove(Fml,[X|Label],[X|Univ],Lits,
              [(UnivT:LabelT:Fml)|UnExp],NewSleep,Free,Limit).
